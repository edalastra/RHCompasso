...
if($count == 1){
    ...
    mysqli_query($conn,"INSERT INTO `documentacao`(`DOCUMENTACAO_ID`, `ID_USUARIO`, `COD_RASTREIO`, `FORMULARIOS_ENVIADOS`, `FORMULARIOS_RECEBIDOS`, `DOCUMENTOS_FISICOS`, `CTPS_RECEBIDA`) VALUES (NULL,$id,NULL,NULL,NULL,NULL)");
